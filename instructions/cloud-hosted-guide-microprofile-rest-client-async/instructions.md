...
> Then from the menu of the IDE, select **File** > **Open** > guide-microprofile-rest-client-async/start/finish/query/src/test/java/it/io/openliberty/guides/query/QueryServiceIT.java
