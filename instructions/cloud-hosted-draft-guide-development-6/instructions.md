...
* **Properties** (**properties**): Any properties for the project go here, 
...
* **Dependencies** (**dependencies**): Any Java dependencies that are 
required for compiling, testing, and running the application are listed here.
* **Build plugins** (**build**): Maven is modular and each of its 
