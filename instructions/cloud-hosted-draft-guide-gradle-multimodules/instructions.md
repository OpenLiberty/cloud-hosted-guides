...
The fastest way to work through this guide is to clone the [Git repository](https://github.com/openliberty/draft-guide-gradle-multimodules.git) and use the projects that are provided inside:

```bash
git clone https://github.com/openliberty/draft-guide-gradle-multimodules.git
cd draft-guide-gradle-multimodules
```
...
> ***File*** > ***Open*** > draft-guide-gradle-multimodules/start/war/build.gradle, or click the following button

::openFile{path="/home/project/draft-guide-gradle-multimodules/start/war/build.gradle"}
...
> To open the build.gradle file in your IDE, select
> ***File*** > ***Open*** > draft-guide-gradle-multimodules/start/ear/build.gradle, or click the following button

::openFile{path="/home/project/draft-guide-gradle-multimodules/start/ear/build.gradle"}
...
```bash
touch /home/project/draft-guide-gradle-multimodules/start/ear/src/main/liberty/config/server.xml
```


> Then, to open the server.xml file in your IDE, select
> ***File*** > ***Open*** > draft-guide-gradle-multimodules/start/ear/src/main/liberty/config/server.xml, or click the following button

::openFile{path="/home/project/draft-guide-gradle-multimodules/start/ear/src/main/liberty/config/server.xml"}
...
> ***File*** > ***Open*** > draft-guide-gradle-multimodules/start/settings.gradle, or click the following button

::openFile{path="/home/project/draft-guide-gradle-multimodules/start/settings.gradle"}
...
> To open the build.gradle file in your IDE, select
> ***File*** > ***Open*** > draft-guide-gradle-multimodules/start/build.gradle, or click the following button

::openFile{path="/home/project/draft-guide-gradle-multimodules/start/build.gradle"}
...
> ***File*** > ***Open*** > draft-guide-gradle-multimodules/start/war/src/main/java/io/openliberty/guides/multimodules/web/HeightsBean.java, or click the following button

::openFile{path="/home/project/draft-guide-gradle-multimodules/start/war/src/main/java/io/openliberty/guides/multimodules/web/HeightsBean.java"}
...
> ***File*** > ***Open*** > draft-guide-gradle-multimodules/start/jar/src/main/java/io/openliberty/guides/multimodules/lib/Converter.java, or click the following button

::openFile{path="/home/project/draft-guide-gradle-multimodules/start/jar/src/main/java/io/openliberty/guides/multimodules/lib/Converter.java"}
...
> Run the following touch command in your terminal
```bash
touch /home/project/draft-guide-gradle-multimodules/start/ear/src/test/java/it/io/openliberty/guides/multimodules/IT.java
```


> Then, to open the IT.java file in your IDE, select
> ***File*** > ***Open*** > draft-guide-gradle-multimodules/start/ear/src/test/java/it/io/openliberty/guides/multimodules/IT.java, or click the following button

::openFile{path="/home/project/draft-guide-gradle-multimodules/start/ear/src/test/java/it/io/openliberty/guides/multimodules/IT.java"}
...
Delete the ***draft-guide-gradle-multimodules*** project by running the following commands:

```bash
cd /home/project
rm -fr draft-guide-gradle-multimodules
```
...
* [Give us feedback](https://openliberty.skillsnetwork.site/thanks-for-completing-our-content?guide-name=Creating%20a%20multi-module%20application%20with%20Gradle&guide-id=cloud-hosted-draft-guide-gradle-multimodules)

### What could make this guide better?

You can also provide feedback or contribute to this guide from GitHub.
* [Raise an issue to share feedback.](https://github.com/OpenLiberty/draft-guide-gradle-multimodules/issues)
* [Create a pull request to contribute to this guide.](https://github.com/OpenLiberty/draft-guide-gradle-multimodules/pulls)
